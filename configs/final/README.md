...
- `*_branch_norm.yaml` uses `grad_balance.method: independent`; the paper labels this operation **GradNorm-only**, while the repository calls the exact implementation **BranchNorm**.
